...
\begin{document}
    ...
    % \section{Introduction}
        ...
        I have experience in designing, training and evaluating deep learning models for speech, video and text, as well as communicating my work in oral and written form for audiences with various degrees of expertise.
    ...
    \section{Open-source projects}
        ...
        \begin{twocolentry}{\href{https://github.com/carlosfranzreb/spkanon_eval}{github/spane}}
            ...
            \begin{highlights}
                \item Includes several anonymizers, datasets and the SOTA privacy evaluation.
        ...
        \begin{twocolentry}{\href{https://github.com/carlosfranzreb/ravas}{github/ravas}}
            ...
            \begin{highlights}
                \item Designed for video-calls (0.1s latency). It's easy to install and use with the GUI.
                \item Runs locally, with a multi-threaded and sync-preserving architecture.
                \item Features a new voice anonymizer based on the streaming speech tokenizer Mimi.
            \end{highlights}
        \end{twocolentry}
        ...
        \begin{twocolentry}{\href{https://github.com/carlosfranzreb/myclimbz}{github/myclimbz}}
            ...
            \begin{highlights}
                \item Videos can be clipped on-device, assisted by a temporal transformer trained on climbing videos. ViT fine-tuned with LoRA is used for feature extraction.
            \end{highlights}
        \end{twocolentry}
