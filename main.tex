...
\begin{entrylist}
  \entry
    ...
    \begin{itemize}[leftmargin=*, itemsep = 0.1em]
        ...
        \item Retrieved and visualized tweets with D3.js to analyse spread of misinformation.\\
    \end{itemize}}
...
\begin{entrylist}
   ...
   \entry
    ...
    \begin{itemize}[leftmargin=*, itemsep = 0.1em]
        ...
        \item Project: built a LSTM network for protein structure prediction in PyTorch.
